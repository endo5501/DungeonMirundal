...
* [ ] 全体的に、4階層より深いメニューからの戻る処理が正常に動作していない。 各メニューの階層は @docs/feature_menu_structure.md 参照
    * [宿屋]-[冒険の準備]-[アイテム整理]-[キャラクター別アイテム管理]を表示したあと、[戻る]を押しても戻らない
    * [魔術師ギルド]-[キャラクター個別分析]-[キャラクタ]を表示したあと、[戻る]が無い
* [ ] [魔術師ギルド]-[魔術書購入]-選択-[はい] : メニューが消えたり"ERROR - ダイアログアクションコールバックエラー: MagicGuild._show_spellbook_details.<locals>.<lambda>() takes 0 positional arguments but 1 was given"
* [ ] [宿屋]-[酒場の噂話]のあと[OK]を押すとメニューが空になる
